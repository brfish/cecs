...
local World = class("cherry_cecs_World")
...
function World:addComponentToEntity(entity, component)
...
function World:removeComponentFromEntity(entity, component)
...
function World:addEventSystem(system)
...
function World:removeEventSystem(system)
	self.eventSystems[system] = nil
	self.eventSystemCount = self.eventSystemCount-1
end

function World:getSystemCount()
...
function World:getEventSystemCount()
...
function World:updateEventSystem(dt)
...
function World:updateEvents(dt)
	self.eventManager:distribute(dt)
end

function World:isSystemExisted(system)
